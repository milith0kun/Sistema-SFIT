...
mixin _$FleetEntryModel {
 ...
 String? get vehicleId; String? get vehiclePlate; String? get routeId; String? get routeName; String? get driverId; String? get driverName; String? get departureTime; String? get returnTime; double? get distanceMeters; int? get durationSeconds; double? get routeCompliancePercentage; int? get checkpointsHit; int? get totalCheckpoints; String? get observations; Map<String, dynamic>? get capture;// {status: validated|raw|merged|rejected|candidate}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,status,vehicleId,vehiclePlate,routeId,routeName,driverId,driverName,departureTime,returnTime,distanceMeters,durationSeconds,routeCompliancePercentage,checkpointsHit,totalCheckpoints,observations,const DeepCollectionEquality().hash(_capture),const DeepCollectionEquality().hash(_trackPoints),const DeepCollectionEquality().hash(_visitedStops),createdAt,updatedAt]);
